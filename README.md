...
## Environments
- Preview: https://main--aemforms-boilerplate--arnehjain.hlx.page/
- Live: https://main--aemforms-boilerplate--arnehjain.hlx.live/
...
1. Open the `aemforms-boilerplate` directory in your favorite IDE and start coding :)
